		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Work-To List",
									"targetURL": "#comreckittzpeworklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comreckittzpeworklist-display": {
								"semanticObject": "comreckittzpeworklist",
								"action": "display",
								"description": "display of the production order operations data ",
								"title": "Work-To List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.reckitt.zpeworklist",
									"url": sap.ui.require.toUrl("com/reckitt/zpeworklist")
								}
							}
						}
					}
